"""
Run-scoped JSONL receipt ledger (SpeedLight-compatible).

Canonical implementation for per-run ``ledger.jsonl`` receipts.
``cmplx.receipt.file_ledger`` re-exports with deprecation warning.
"""
