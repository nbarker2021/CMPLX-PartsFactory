...
Source: ``CMPLX-history/staging/by-family/unclassified/partsfactory/ledger.py``
Slot: ``slot-02-nsl-phi``
"""
import os, json, time, hashlib, hmac, base64, threading, uuid
...
class ReceiptLedger:
    ...
    def close(self) -> None:
        """No-op close; ledger is append-only."""
        return

def new_key_b64():
    return base64.b64encode(os.urandom(32)).decode("ascii")

def new_run_id(prefix="civ"):
