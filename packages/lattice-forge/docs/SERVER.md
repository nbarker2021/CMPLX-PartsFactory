...
- `GET /rule30/field-address/{n}`
- `GET /rule30/field-address/{n}/verify`
- `GET /rule30/exit-trajectory/{n}`
- `GET /rule30/exit-trajectory/{n}/verify`
- `GET /rule30/sheet-lift/{n}`
- `GET /rule30/sheet-lift/{n}/verify`
- `GET /rule30/julia-resolution/{n}`
- `GET /rule30/julia-resolution/{n}/verify`
- `GET /rule30/torsor-functor/{n}`
- `GET /rule30/torsor-functor/{n}/verify`
- `GET /rule30/spinor-oloid`
- `GET /rule30/spinor-oloid/verify`
- `GET /rule30/oloid-winding/{n}`
- `GET /rule30/oloid-winding/verify`
- `GET /rule30/oloid-antipode/{n}`
- `GET /rule30/oloid-antipode/verify`
- `GET /rule30/oloid-scan`
- `GET /rule30/winding-number`
- `GET /rule30/winding-number/verify`
